...
<div class="content-wrapper">
	...
	<section class="content">
		<?php
				$b=$sql->run("SELECT u.nama_lengkap,u.email FROM tb_userpublic u JOIN tb_biodata b ON (b.ref_iduser=u.iduser) WHERE u.iduser='".$p['ref_iduser']."' LIMIT 1");
				$bio=$b->fetch();
				?>
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">Data Permohonan & Barang</h3>
					</div>
					<div class="box-body">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">Dokumentasi Pemeriksaan</h3>
					</div>
					<div class="box-body">
						<table class="table">
						<?php
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">Draft Berita Acara Pemeriksaan</h3>
					</div>
					<div class="box-body">
						<?php
						//load hasil data BAP
			...
			<div class="col-md-12">
				<div class="box">
					...
					<div class="box-footer">
						<a target="_blank" href="<?php echo c_DOMAIN_UTAMA."download.php?surat=".$kdsurat."&token=".md5('download'.$kdsurat.'public');?>" class="btn btn-sm btn-primary btn_check btn-flat">Download Surat</a>
					</div>
				</div>
			</div>
		</div>
