				...
				<form class="form-horizontal" action="" method="POST" name="fupdatehslperiksa" id="fupdatehslperiksa">
					...
					<div id="app">
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								<input type="number" step="any" name="pjg" class="form-control" value="<?php echo $dtrow['pjg'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Lebar (Cm)</label>
							<div class="col-md-3">
								<input type="number" step="any" name="lbr" class="form-control" value="<?php echo $dtrow['lbr'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Berat Sampel(Kg)</label>
							<div class="col-md-3">
								<input type="number" step="any" name="berat" class="form-control" value="<?php echo $dtrow['berat'];?>">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label">Panjang (Cm)</label>
							<div class="col-md-3">
								<input type="number" step="any" name="pjg2" class="form-control" value="<?php echo $dtrow['pjg2'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Lebar (Cm)</label>
							<div class="col-md-3">
								<input type="number" step="any" name="lbr2" class="form-control" value="<?php echo $dtrow['lbr2'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Berat Sampel(Kg)</label>
							<div class="col-md-3">
								<input type="number" step="any" name="berat2" class="form-control" value="<?php echo $dtrow['berat2'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Berat Total (Kg)</label>
							<div class="col-md-4">
								<input type="number" step="any" name="berat_tot" class="form-control" value="<?php echo $dtrow['tot_berat'];?>">
							</div>
						</div>
						<div class="form-group">
