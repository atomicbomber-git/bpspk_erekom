...
<section role="main" class="content-body">
	...
	<div class="row">
		<div class="col-md-7">
			<section class="panel panel-featured panel-featured-primary">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Referensi PSDKP</h2>
				</header>
				
				<div class="panel-body">
					<table class="table table-hover table-striped mb-none" id="ref-dtpsdkp">
						<thead>
							<tr>
								<th width="20px;">#</th>
								<th>Nama</th>
						...
						<tbody id="isi_table">
						<?php
						$q=$sql->run("SELECT * FROM ref_psdkp WHERE isDelete=0 ORDER BY nama ASC");
						$no=1;
						foreach ($q->fetchAll() as $row) {
						    ...
						    <tr>
						        ...
						        <td><a href='#edit' class='text-bold'>".$row['nama']."</a>
						        	...
						        	<a href='./edit-psdkp.php?landing=".base64_encode($row['id_psd'])."'>Edit</a> 
						        	<a href='#' data-id='".base64_encode($row['id_psd'])."' class='row-delete'>Delete</a>
						        	</p>
						        </td>
						        <td>".$row['email']."</td>
						    </tr>
		...
		<div class="col-md-5">
			<form id="dtpsdkp_add" class="form-horizontal" method="post">
				<input type="hidden" name="a" id="a" value="addpsdkp" />
				<section class="panel panel-featured panel-featured-primary">
					<header class="panel-heading">
						<div class="panel-actions">
							<a href="#" class="fa fa-caret-down"></a>
