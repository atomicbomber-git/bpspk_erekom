...
?>
<form id="form_pemeriksaan" method="post">
			...
			<section class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<input type="text" name="tgl_pemeriksaan" data-plugin-datepicker data-date-orientation="top" class="form-control">
						</div>
					</div>
					<hr/>
									...
									<div class="row">
										<div class="col-md-6 ak_div">
											...
											<select name="asal_komoditas_opt[]" class="form-control asal_komoditas">
												<option value="">-Pilih-</option>
												<?php
												$ak=$sql->run("SELECT DISTINCT(asal_komoditas) ak FROM tb_barang where ref_idphn='$idpengajuan'");
												if($ak->rowCount()>0){
											...
											<input type="text" style="display:none" name="asal_komoditas[]" class="form-control custom_ak" value="">
										</div>
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-md-12">
							...
							<button type="submit" class="btn btn-primary btn_simpan">Simpan Hasil Pemeriksaan</button>
