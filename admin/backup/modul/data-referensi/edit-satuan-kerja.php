...
$sql->get_row('ref_satuan_kerja',array('id_satker'=>$idsatker),array('id_satker','nm_satker'));
$ikan=$sql->result;
$found=$sql->num_rows;
				...
				<section class="panel">
					...
					<div class="panel-body">
						<div class="form-group">
							<div class="col-md-12">							
								<label class="control-label" for="satker">Nama Ikan</label>
								<input name="satker" id="satker" placeholder="Nama Satuan Kerja" type="text" class="form-control" value="<?php echo $ikan['nm_satker'];?>">
							</div>
						</div>
