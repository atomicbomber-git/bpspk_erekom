...
<section role="main" class="content-body">
	<header class="page-header">
		<h2>Referensi Balai Karantina</h2>
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				<li><a href="<?php echo c_MODULE;?>"><i class="fa fa-home"></i></a></li>
				<li><span>Referensi Balai Karantina</span></li>
			</ol>
	...
	<div class="row">
		<div class="col-md-7">
			<section class="panel panel-featured panel-featured-primary">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Referensi Balai Karantina</h2>
				</header>
				
				<div class="panel-body">
					<table class="table table-hover table-striped mb-none" id="ref-dtbk">
						<thead>
							<tr>
								<th width="20px;">#</th>
								<th>Nama</th>
						...
						<tbody id="isi_table">
						<?php
						$q=$sql->run("SELECT * FROM ref_balai_karantina ORDER BY nama ASC");
						$no=1;
						foreach ($q->fetchAll() as $row) {
						    ...
						    <tr>
						        ...
						        <td><a href='#edit' class='text-bold'>".$row['nama']."</a>
						        	...
						        	<a href='./edit-balai-karantina.php?landing=".base64_encode($row['idbk'])."'>Edit</a> 
						        	<a href='#' data-id='".base64_encode($row['idbk'])."' class='row-delete'>Delete</a>
						        	</p>
						        </td>
						        <td>".$row['email']."</td>
						    </tr>
		...
		<div class="col-md-5">
			<form id="dtbk_add" class="form-horizontal" method="post">
				<input type="hidden" name="a" id="a" value="adddtbk" />
				<section class="panel panel-featured panel-featured-primary">
					<header class="panel-heading">
						<div class="panel-actions">
							<a href="#" class="fa fa-caret-down"></a>
