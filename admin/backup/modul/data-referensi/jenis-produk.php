...
<section role="main" class="content-body">
	<header class="page-header">
		<h2>Referensi Jenis Produk</h2>
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				<li><a href="<?php echo c_MODULE;?>"><i class="fa fa-home"></i></a></li>
				<li><span>Referensi Jenis Produk</span></li>
			</ol>
	...
	<div class="row">
		<div class="col-md-7">
			<section class="panel panel-featured panel-featured-primary">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Referensi Jenis Produk</h2>
				</header>
				
				<div class="panel-body">
					<table class="table table-hover table-striped mb-none" id="ref-dtjproduk">
						<thead>
							<tr>
								<th width="20px;">#</th>
								<th>Nama Produk</th>
						...
						<tbody id="isi_table">
						<?php
						$q=$sql->run("SELECT * FROM ref_jns_sampel");
						$no=1;
						foreach ($q->fetchAll() as $row) {
						    echo "
						    <tr>
						        <td>".$no."</td>
						        <td><a href='#edit' class='text-bold'>".$row['jenis_sampel']."</a>
						        	<p class=\"actions-hover actions-fade\"> 
						        	<a href='./edit-jenis-produk.php?landing=".base64_encode($row['id_ref'])."'>Edit</a> 
						        	<a href='#' data-id='".base64_encode($row['id_ref'])."' class='row-delete'>Delete</a>
						        	</p>
						        </td>
						    </tr>
						    ";
		...
		<div class="col-md-5">
			<form id="dtjproduk_add" class="form-horizontal" method="post">
				<input type="hidden" name="a" id="a" value="adddtjproduk" />
				<section class="panel panel-featured panel-featured-primary">
					<header class="panel-heading">
						<div class="panel-actions">
							<a href="#" class="fa fa-caret-down"></a>
					...
					<div class="panel-body">
						<div class="form-group">
							<div class="col-md-12">							
								...
								<input name="nm_jenis" id="nm_jenis" placeholder="Nama Produk" type="text" class="form-control">
							</div>
						</div>			
					</div>
					<footer class="panel-footer">
